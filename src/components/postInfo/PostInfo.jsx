  ...
  return (
    <section className="container__postInformacion">
      ...
      <article className="file__info">
        ...
        aut expedita aspernatur earum qui eveniet ut mollitia inventore,
        praesentium asperiores, tenetur repudiandae at quaerat, consectetur
        nulla? Porro veniam, distinctio id asperiores, ducimus architecto
        pariatur rem adipisci eius, nobis unde?
      </article>
    </section>
  );
};
